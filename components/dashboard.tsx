...
import { Menu, X, Coins, CircleDollarSign, BarChart3 } from "lucide-react"
...
const projectsData: ProjectsDataType = {
  ...
  "Project B": [
    { date: "2023-01", inCirculation: 500, consumed: 0, newTokens: 500, returnedTokens: 0 },
    { date: "2023-02", inCirculation: 450, consumed: 50, newTokens: 0, returnedTokens: 25 },
    { date: "2023-03", inCirculation: 400, consumed: 100, newTokens: 25, returnedTokens: 50 },
    { date: "2023-04", inCirculation: 350, consumed: 150, newTokens: 0, returnedTokens: 75 },
    { date: "2023-05", inCirculation: 250, consumed: 250, newTokens: 50, returnedTokens: 100 },
    { date: "2023-06", inCirculation: 150, consumed: 350, newTokens: 0, returnedTokens: 125 },
    { date: "2023-07", inCirculation: 50, consumed: 450, newTokens: 25, returnedTokens: 100 },
  ],
  "Project C": [
    { date: "2023-01", inCirculation: 200, consumed: 0, newTokens: 200, returnedTokens: 0 },
    { date: "2023-02", inCirculation: 180, consumed: 20, newTokens: 0, returnedTokens: 10 },
    { date: "2023-03", inCirculation: 160, consumed: 40, newTokens: 10, returnedTokens: 20 },
    { date: "2023-04", inCirculation: 140, consumed: 60, newTokens: 0, returnedTokens: 30 },
    { date: "2023-05", inCirculation: 100, consumed: 100, newTokens: 20, returnedTokens: 40 },
    { date: "2023-06", inCirculation: 60, consumed: 140, newTokens: 0, returnedTokens: 50 },
    { date: "2023-07", inCirculation: 20, consumed: 180, newTokens: 10, returnedTokens: 40 },
  ],
}
...
export default function Dashboard() {
  ...
  const currentProjectData = projectsData[selectedProject]
  const totalTokens = currentProjectData[0].inCirculation + currentProjectData[0].consumed
  const tokensInCirculation = currentProjectData[currentProjectData.length - 1].inCirculation
  const tokensConsumed = currentProjectData[currentProjectData.length - 1].consumed
        ...
        <div className="container mx-auto p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            <Card className="bg-[#1B1B1B] border-[#2D2D2D]">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <Coins className="h-8 w-8 text-[#4FDEE5]" /> {/* Increased size */}
              </CardHeader>
              <CardContent>
                <div className="text-4xl font-bold text-[#F1F1F3]">{totalTokens}</div>
            ...
            <Card className="bg-[#1B1B1B] border-[#2D2D2D]">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <CircleDollarSign className="h-8 w-8 text-[#4FDEE5]" /> {/* Increased size */}
              </CardHeader>
              <CardContent>
                <div className="text-4xl font-bold text-[#F1F1F3]">{tokensInCirculation}</div>
            ...
            <Card className="bg-[#1B1B1B] border-[#2D2D2D]">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                ...
                <BarChart3 className="h-8 w-8 text-[#4FDEE5]" /> {/* Increased size */}
              </CardHeader>
              <CardContent>
                <div className="text-4xl font-bold text-[#F1F1F3]">{tokensConsumed}</div>
                <p className="text-xs text-[#B4B4B4]">All time</p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="mb-10 bg-[#1B1B1B] border-[#2D2D2D]">
            <CardHeader>
              ...
              <CardDescription className="text-[#B4B4B4] text-sm">Overview of token distribution over time for {selectedProject}</CardDescription>
            </CardHeader>
            <CardContent>
